...
///
/// For example, two coordinate systems that implement `CoordinateSystem<Convention = NedLike>` both
/// behave [`NedLike`], and get appropriately-named accessors on types like [`Coordinate`] and
/// [`Vector`] (ie, `north`, `east`, and `down`).
///
